...
const ContactMe = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await emailjs.send('service_z3hvpac', 'template_cin7h92', templateParams, 'qAiZcr0joDBLz3PNK');
                            ...
                            <Row>
                                ...
                                <Col sm={12} className="px-1">
                                    <textarea
                                        ...
                                        className="form-control"
                                    />
                                    <button type="submit" className="btn-submit"><span>{buttonText}</span></button>
                                    {
                                        status.message && 
